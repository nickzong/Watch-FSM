[README.md](https://github.com/user-attachments/files/32216956/README.md)
# Watch-FSM
...
Three buttons (Mode / Set / Plus) are reused contextually across modes, plus an # Watch-FSM
...
asynchronous alarm input. Simultaneous inputs are resolved deterministically with a priority-encoded scheme: **alarm > mode > set > plus (AMSP)**.
